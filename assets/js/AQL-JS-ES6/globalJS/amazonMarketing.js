// Amazon Marketing
 var _paPixel = _paPixel || [];
  ...
  _paPixel.push(['submit']);
   () => {
	  "use strict";
    let paPixel = document.createElement('script'); paPixel.type = 'text/javascript'; paPixel.async = true;
    paPixel.src = '//d10so77biaxg0k.cloudfront.net/pa_pixel.js';
    let s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(paPixel, s);
  };