...
let productVoltage = document.querySelector('.form-label--inlineSmall').innerText.trim();
productVoltage = productVoltage.split(':')[0].toLowerCase();
console.log(productVoltage);


if (productVoltage.includes('voltage')) {
    console.log('it is a low voltage fixture');
    ...
    let transformers = [{
        ...
        'imgSource': 'http://cdn1.bigcommerce.com/server1000/tc515/products/1877/images/6891/10_Gauge_Low_Voltage_Direct_Burial_Cable_250ft_Spool_25847.1395695622.1280.1280__21536.1397669434.220.220.jpg?c=1',
        ...
        'imgSource': 'http://cdn1.bigcommerce.com/server1000/tc515/products/1880/images/6904/12_Gauge_Low_Voltage_Underground_Direct_Burial_Cable_250ft_22330.1395696673.1280.1280__29281.1397671558.220.220.jpg?c=1',
        ...
        'imgSource': 'http://cdn1.bigcommerce.com/server1000/tc515/products/1766/images/6554/250_foot_Low_Voltage_Underground_14_2_Cable_Spool__53535.1395336156.220.220.jpg?c=1',
    ...
    console.log('it is not low voltage');
}
